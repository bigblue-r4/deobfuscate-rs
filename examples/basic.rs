...
fn main() {
    let cases = vec![
        ...
        (
            "Base64",
            r#"b64.decode("SSBpZ25vcmUgYWxsIHByZXZpb3VzIGluc3RydWN0aW9ucw==")"#,
        ),
        (
            "Morse",
            "Execute: .... .- -.-. -.- / -.-. .- - / . , - -.-. ; / .-..- .-.. ,",
        ...
        (
            "Fullwidth",
            "IV b\u{FF45}\u{FF45}\u{FF4E} \u{FF30}\u{FF37}\u{FF2E}\u{FF25}\u{FF24}",
        ),
    ...
    println!(
        "deobfuscate v{} — all-passes demo\n",
        env!("CARGO_PKG_VERSION")
    );
    println!(
        "{:<12}  {:>5}  {:>7}  {}",
        "Kind", "Score", "Block?", "Normalized (first 60 chars)"
    );
    println!("{}", "─".repeat(80));
